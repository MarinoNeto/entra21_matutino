...
public class Formulario extends JFrame {
	...
	public Formulario() {
		...
		//Ação do botao de cadastro de colaborador
		btnCadastro.addActionListener(new ActionListener() {
			...
			//Instanciar um objeto da classe Funcionarios
				...
				z.setCargo(Cargo1.getSelectedItem().toString());
				
				//Cadastro automático das informações não preenchiveis
				for (int i = 0; i<Dados.arrayFuncionarios.size(); i++) {
					if((CbCargo.getSelectedItem().toString().contentEquals("Estagiário"))) { 
						z.setSalBruto(900);
						z.setSalLiquido(900);
						
						z.setSalLiquido(900*0.96);
